...
% function result = SplitAndMerge(dists, angles, L, Pose)
% 
% argumentos:
...
i1 = 1; % indice do primeiro ponto que forma a reta de analise
i2 = n; % indice do segundo ponto que forma a reta de analise
